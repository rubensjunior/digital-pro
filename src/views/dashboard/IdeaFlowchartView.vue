  ...
  <div class="nn-page" :class="{ 'nn-presentation': isFullscreen }">
    ...
    <div class="nn-topbar">
      ...
      <div class="nn-topbar-right">
        ...
        <button class="nn-ctrl-btn" @click="toggleFullscreen" :title="isFullscreen ? 'Sair da Apresentação (Esc)' : 'Modo Apresentação'">
...
/* Modo Apresentação: cobre toda a janela Electron */
.nn-presentation {
