...
Para infoprodutores profissionais! O Digital PRO é uma plataforma robusta projetada para gerenciar ideias, estratégias de marketing, desenvolvimento de software e fluxos de trabalho operacionais.
...
3. Inicie o ambiente de desenvolvimento: `npm start`.

## Tecnologias Utilizadas

- **Core**: Electron + Vite
- **Frontend**: Vue 3 + TypeScript
- **Estilo**: Vanilla CSS (Metronic-style)
- **Banco de Dados**: SQLite (better-sqlite3)
- **Backend Cloud**: Supabase (Auth & Profile sync)
- **Editor**: Tiptap Rich Text Editor

---
Desenvolvido por **RKS Tech Solution**.
